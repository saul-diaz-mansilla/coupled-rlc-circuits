...
for i in range(72):
    ...
    CH1 = pd.read_csv(r"RL_diode_run_2\ALL"+number+r"\F"+number+r"CH1.CSV", header=None)
    CH2 = pd.read_csv(r"RL_diode_run_2\ALL"+number+r"\F"+number+r"CH2.CSV", header=None)
