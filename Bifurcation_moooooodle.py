...
for i in range(72):
    ...
    CH1 = pd.read_csv(r"C:\Users\Usuario\Documents\Documentos\Universidad\Tecnicas experimentales II\Proyecto\moooooodle\ALL"+number+r"\F"+number+r"CH1.CSV", header=None)
    CH2 = pd.read_csv(r"C:\Users\Usuario\Documents\Documentos\Universidad\Tecnicas experimentales II\Proyecto\moooooodle\ALL"+number+r"\F"+number+r"CH2.CSV", header=None)
